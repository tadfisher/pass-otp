...
If you use the `rofi` or `dmenu` selector, the `pass` extension [select-pass-otp](https://github.com/Konfekt/select-pass-otp) provides a menu to paste or copy any password or OTP.
